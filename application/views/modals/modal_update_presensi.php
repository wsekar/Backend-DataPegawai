    ...
    <form method="POST" id="form-update-pegawai">
        ...
        <div class="input-group form-group">
            ...
            <select name="kota" class="form-control select2" aria-describedby="sizing-addon2">
                ...
                ?>
                    <option value="<?php echo $kota->nama; ?>" <?php if ($kota->nama == $dataPegawai->kota) {
        ...
        <div class="input-group form-group" style="display: inline-block;">
            ...
            <span class="input-group-addon">
                <input type="radio" name="jk" value="Laki-laki" id="laki" class="minimal" <?php if ($dataPegawai->kelamin == 'Laki-laki') {
                                                                                                echo "checked='checked'";
                                                                                            } ?>>
                <label for="laki">Laki-laki</label>
            </span>
            <span class="input-group-addon">
                <input type="radio" name="jk" value="Perempuan" id="perempuan" class="minimal" <?php if ($dataPegawai->kelamin == 'Perempuan') {
                                                                                                    echo "checked='checked'";
                                                                                                } ?>>
        ...
        <div class="input-group form-group">
            ...
            <select name="jabatan" class="form-control select2" aria-describedby="sizing-addon2">
                ...
                ?>
                    <option value="<?php echo $jabatan->nama; ?>" <?php if ($jabatan->nama == $dataPegawai->jabatan) {
                                                                        echo "selected='selected'";
                                                                    } ?>><?php echo $jabatan->nama; ?></option>
                <?php
                }
                ?>
            </select>
